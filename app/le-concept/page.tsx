...
import { ArrowRight, Heart, Sparkles, Star, Palette, Gift } from "lucide-react"
      ...
      <section className="py-16 md:py-24 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <motion.div variants={fadeIn} className="prose prose-lg max-w-none text-rose-800 mb-12">
